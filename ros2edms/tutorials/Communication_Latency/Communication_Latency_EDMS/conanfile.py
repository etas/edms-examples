...
class Example(ConanFile):
    ...
    aos_version = os.getenv("AOS_VERSION","0.37.0")
    aos_channel = os.getenv("AOS_CHANNEL","sdk")

    options = {
        "ROS": ["ON", "OFF"],
        "ROS_INITIALIZATION": ["ON", "OFF"],
        "CODE_GENERATOR": ["yaaac2"],
        "MIDDLEWARE_TARGET": ["noviroc"],
    ...
    def build_requirements(self):
        ...
        self.build_requires(f"aos_ros_tools/{self.aos_version}@aos/{self.aos_channel}")
    ...
    def requirements(self):
        ...
        self.requires(f"aos_runtime_ros/{self.aos_version}@aos/{self.aos_channel}")
